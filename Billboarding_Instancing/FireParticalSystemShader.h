...
/*		float gTimeStep;
	...
	float3 gEyePosW;
	float4x4 gViewProj;*/ 
	struct ParticleParametersBufferType
	{
		float gTimeStep;
		float gGameTime;
...
private:
	...
	bool SetShaderParameters_Draw(ID3D11DeviceContext*, D3DXMATRIX, D3DXMATRIX, D3DXMATRIX, ID3D11ShaderResourceView*);
...
private:
	...
	ID3D11Buffer* m_particle_parameter_buffer;

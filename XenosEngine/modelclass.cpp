...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
	...
	D3D11_SUBRESOURCE_DATA vertexData, indexData; // Subresource, holds the actuall data for buffer which is used to create buffer.
	HRESULT result;
	...
	// Setup Subresource, which will hold the data for vertex buffer.
	// Give the subresource structure a pointer to the vertex data.
	vertexData.pSysMem = vertices; // TODO
